    ...
    <div className="relative inline-block">
      ...
      {isOpen && (
        <>
          ...
          />
          <div className="absolute right-0 mt-2 w-48 bg-white rounded-lg shadow-lg border z-50 p-2">
            ...
            {shareLinks.map((link) => (
              <button
                ...
                className={`w-full flex items-center gap-2 px-3 py-2 rounded-md text-sm transition-colors ${link.color}`}
              >
